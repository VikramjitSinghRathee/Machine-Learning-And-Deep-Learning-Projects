...
Info: In this project, 3 supervised algorithms were implemented to accurately model individuals' income using data collected from the 1994 U.S. Census. The goal with this implementation is to construct a model that accurately predicts whether an individual makes more than $50,000. This sort of task can arise in a non-profit setting, where organizations survive on donations. Understanding an individual's income can help a non-profit better understand how large of a donation to request, or whether or not they should reach out to begin with. While it can be difficult to determine an individual's general income bracket directly from public sources, we can (as we will see) infer this value from other publically available features.

The 3 algorithm's implemented were Decision Tree Classification, Support Vector Machine Classification and Gaussian Naive Bayes Classification. The performance of these algorithms were further tuned by optimizing parameters via gridsearchCV library from sklearn. Furthermore extracted feature importance using sklearn and then utilized the reduced features as input in the best classifier model to compare performance.
